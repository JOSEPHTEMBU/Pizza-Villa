...
$(document).ready(function () {
	...
	$("#checkout-form").submit(function (e) {
	  ...
	  if (deliveryOption === "deliver") {
		$(".location").show();
		$(".delivery-cost").show();
		$("#delivery-amount").append(30);
		totalCost += 
		$("#total-amount").empty();
		$("#total-amount").append(totalCost);
	  }else{
		alert(customerName + ": Your total bill is $. " + totalCost + ". Your order will be ready for collection " );
	  }
	});
	...
	$("#location-form").submit(function (e) {
	  ...
	  $(".location").hide();
	  alert(customerName + ": Your total bill is $. " + totalCost + ". Your order will be delivered to "+ estate + ", " + houseNumber +" in the next 3 hours" );
	});
  });
...
function contact(form) {
	...
	alert("Hello! " + name + "," + " Thank you, We have received your message. ");
}
