...
$(document).ready(function () {
	$("#form2").submit(function (event) {
		...
		var deliverPrices = [$20, 0];
		var sizePrices = [$60, $90, $120];
		...
		alert(
			"your order is " +
				newDetails.selectedType +
				", " +
				newDetails.selectedToppings +
				", and " +
				newDetails.selectedCrust +
				". click ok to view your total bill"
		);
		alert(newBill + "");
